...
sp2 = Dataset.create(name: "Yeild Curve", srcName: "FRED", srcAddress: "https://api.stlouisfed.org/fred/series/observations?series_id=T10Y2Y&api_key=#{ENV['FRED_SECRET']}&file_type=json", desc:"The slope of the yield curve is one of the most powerful predictors of future economic growth, inflation, and recessions. A high value can predict a strong and growing economy, a low or negative value often indicates a looming reccession.", normalizer:"percent")
